classdef TestKernel < quadest.test.TestBase
%TESTKERNEL Unit tests for +quadest/+kernel module
%
%   Tests for Kernel and StokesStresslet
    ...
    methods
        ...
        function test_stresslet_creation(obj)
            ...
            k = quadest.kernel.StokesStresslet();
            obj.assertTrue(isa(k, 'quadest.kernel.StokesStresslet'));
            obj.assertTrue(isa(k, 'quadest.kernel.Kernel'));
        end
