classdef StokesStresslet < quadest.kernel.Kernel
    ...
    %
    % See also: quadest.kernel.Kernel
    ...
    methods
        ...
        function ncomp = numComponents(obj)
    ...
    methods (Access = private)
        function u = evaluateSingleSource(obj, targets, source, normal, density, weight)
        ...
        function u = evaluateMultipleSources(obj, targets, sources, normals, density, weights)
