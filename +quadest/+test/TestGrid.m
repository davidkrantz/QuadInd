classdef TestGrid < quadest.test.TestBase
%TESTGRID Unit tests for +quadest/+grid module
%
%   Tests for AxsymGrid and Upsampler
    ...
    methods
        function setUp(obj)
            ...
            obj.geom = quadest.geometry.Spheroid('a', 1, 'c', 2);
            obj.grid = quadest.grid.AxsymGrid(obj.geom, 'nth', 10, 'nph', 16);
        end
        ...
        function test_upsampler_factor2(obj)
            ...
            upsampler = quadest.grid.Upsampler(obj.grid, targetGrid);
