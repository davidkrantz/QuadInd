classdef Capsule < quadind.geometry.AxsymGeometry
    ...
    %
    % Usage:
    %   geom = quadind.geometry.Capsule();                    % defaults: R=1, L=6, kappa=4
    %   geom = quadind.geometry.Capsule('R', 0.5, 'L', 4);   % custom parameters
    %
    ...
    %
    % See also: quadind.geometry.AxsymGeometry, quadind.geometry.Spheroid, quadind.geometry.Peanut
