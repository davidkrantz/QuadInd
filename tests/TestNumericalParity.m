classdef TestNumericalParity < matlab.unittest.TestCase
    ...
    methods (Test)
        function test_pre_rename_reference_results(testCase)
            ...
            expectedIndicator = [0.22094725865433557; ...
                3.9351058459220134; 6.0210480721307062e-05];
            ...
            expectedFactorIndicators = {expectedIndicator, [ ...
                0.00093511041461729065; 0.25021206824970149; ...
                5.2752050569163598e-11]};
            ...
            testCase.verifyEqual(classification.upsamplingFactor, [3;3;2]);
